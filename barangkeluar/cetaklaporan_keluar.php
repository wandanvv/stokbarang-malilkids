...
$query = "SELECT k.*, s.namabarang, s.kategori 
          FROM keluar k 
...
<head>
    ...
    <title>Laporan Barang Keluar - Malilkids</title>
    <style>
        @media print {
        ...
        .summary-card.warning { background-color: #fff3cd; border-color: #ffeaa7; }
        .summary-card.danger { background-color: #f8d7da; border-color: #f5c6cb; }
...
<body>
    ...
    <div class="summary-cards">
        ...
        <div class="summary-card danger">
            ...
            <div class="number"><?php echo number_format($total_keluar); ?></div>
        </div>
    </div>
    ...
    <div class="print-footer">
        ...
        <p>Total <?php echo $total_items; ?> transaksi barang keluar dengan total <?php echo number_format($total_keluar); ?> unit barang.</p>
    </div>
